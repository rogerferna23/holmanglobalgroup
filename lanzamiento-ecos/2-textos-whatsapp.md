...
En WhatsApp nadie lee ocho líneas. Estos están hechos para leerse de un vistazo
y para que la persona pueda **reenviarlos** sin editar nada.
...
## B) Uno a uno, a alguien que aprecias
...
*(Este es el que mejor funciona. Cuesta más porque hay que mandarlo uno por uno
— y funciona justamente por eso.)*

---

## C) Estado de WhatsApp
...
## D) Para quien te pregunta «¿y qué es exactamente?»
...
## E) Cuando queden pocos lugares

> Quedan {{n}} de los 50 lugares con octubre gratis.
>
> Después de eso el club sigue, pero ya se cobra desde el primer mes.
>
> holmanglobalgroup.com/ecos

*(Úsalo solo cuando sea verdad. El contador de la página es público: si dice
otra cosa, te delata.)*
