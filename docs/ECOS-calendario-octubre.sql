...
--
-- Dias fijos: martes oratoria, viernes ventas; marketing el viernes de la
-- semana 2 y masterclass el viernes de la semana 4.
--
...
values
  ...
  ('2026-10-09-oratoria-practica', '2026-10-09T20:00:00-04:00', 'clase',       'ventas',    'Clase de ventas',       'Zack',   null, false, true),
  ('2026-10-16-marketing',         '2026-10-16T20:00:00-04:00', 'clase',       'marketing', 'Taller de marketing',   'Ingrid', null, false, true),
  ('2026-10-20-ventas',            '2026-10-20T20:00:00-04:00', 'clase',       'oratoria',  'Clase de oratoria',     'Holman', null, false, true),
